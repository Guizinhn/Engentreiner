        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/5511987396856" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#eb0808] transition-colors">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">
              (11) 98739-6856 | (15) 99830-2186
            </p>
            <p className="text-gray-300 mb-2">ogsitescompletos@gmail.com</p>
            <p className="text-gray-300">Rua do Arouche, República – SP</p>
          </div>
        </div>
